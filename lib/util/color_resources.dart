...
class ColorResources {
  static  Color getPrimaryColor() {
    return Get.isDarkMode ? const Color(0xFF002931) : const Color(0xFFe67e30);
  }
  ...
  //
  static Color secondaryColor = const Color(0xFFFA6508);
  static const Color primaryColor = const Color(0xFFe67e30);
