              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    widget.transactionType != 'request_money' ? Text('${'charge'.tr} 0.5 %', style: rubikRegular.copyWith(fontSize: Dimensions.fontSizeLarge,color: Theme.of(context).primaryColor)) : const SizedBox.shrink(),
                    const SizedBox(
                      height: Dimensions.paddingSizeDefault,
                    ),
                    Divider(
