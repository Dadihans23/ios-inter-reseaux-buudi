...
class TransactionMoneyController extends GetxController implements GetxService {
  ...
  Future<Response> sendMoney({required ContactModel contactModel, required double amount, String? purpose, String? pinCode, required Function onSuggest}) async{
    final String? ReceiverName =  contactModel.name ;
    final String? ReceiverNumber =  contactModel.phoneNumber ;
    final String? senderLName = profileController!.userInfo!.fName!;
    final String? senderFName = profileController!.userInfo!.lName!;
    final String message =  "Vous avez reçu $amount FCFA de la part de $senderLName $senderFName\n"
                 "Vérifiez toutes vos opérations dans l'application BUUDI !\n"
                 "''Avec BUUDI, Ton wari est sécurisé''";;
   ...
   if(response.statusCode == 200){
     ...
     _isNextBottomSheet = true;
      ...
      // sendMessage('$ReceiverNumber', message );
     onSuggest();
