...
class OptionCardWidget2 extends StatelessWidget {
  final String? image;
  ...
  const OptionCardWidget2({
    Key? key,
    this.image,
    this.icon, // Initialiser la nouvelle propriété
    this.text,
    this.onTap,
    this.color
  }) : super(key: key);
          ...
          children: [
            ...
            Container(
              ...
              child: SizedBox(
                height: 25,
                width: 25,
                // Utiliser l'icône si elle est fournie, sinon utiliser l'image
                child: icon != null 
                  ? Icon(icon, size: 25) 
