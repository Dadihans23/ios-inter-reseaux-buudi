         ...
         child: Column(
           ...
           children: [
             ...
             Padding(padding: const EdgeInsets.symmetric(horizontal: Dimensions.paddingSizeExtraSmall+1),
               child: Text(text!, textAlign: TextAlign.center, maxLines: 2, style: rubikRegular.copyWith(fontSize: screenWidth*0.03, color: Theme.of(context).textTheme.bodyLarge!.color),),
             )
